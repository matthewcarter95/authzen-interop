...
const config = {
  title: 'OpenID AuthZEN Interop',
  tagline: 'Interoperability testing and results for AuthZEN implementations',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://www.authzen-interop.net',
  ...
  organizationName: 'openid', // Usually your GitHub org/user name.
  projectName: 'authzen', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://todo.authzen-interop.net',
